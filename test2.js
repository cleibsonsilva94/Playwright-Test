...
(async() => {
    const browser = await chrome.launch() // Nas linhas abaixo o padrão dentro do playwright, Chama o browser, o contexto dele e acessa a pág apartir do contexto. 
